...
(function (global, factory) {
  ...
  function extend(a, b, thisArg) {
    ...
    // @weekbin annotations - thisArg was the third argument, while it passed in the fourth argument when copying context to instance
  ...
  function matchAll(regExp, str) {
    ...
    while ((matches = regExp.exec(str)) !== null) {
      // @weekbin annotations - example: /\w+|\[(\w*)]/g can iterate return result of last match
      arr.push(matches);
    }
    ...
    */
    ...
    function resolveURL(url) {
      ...
      return {
        ...
        // @weekbin annotations - host include port, or default(80|443) will not set, example: www.abc.com, www.abc.com:8080
  ...
  var defaults = {
    ...
    // @weekbin annotations - adapt browser and nodejs environment
  ...
  var Axios = /*#__PURE__*/function () {
    function Axios(instanceConfig) {
      ...
      this.interceptors = {
        ...
        // @weekbin annotations - controller of request interceptors
